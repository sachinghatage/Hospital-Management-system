...
public class DoctorServiceImpl implements IDoctorService{
	...
	public DoctorDto getOneDoctor(Long id) {
		DoctorEntity doctorEntity=repo.findById(id).orElseThrow(()->new DoctorNotFoundException("DOCTOR "+id+" NOT EXIST"));
	...
	public void deleteDoctor(Long id) {
		repo.delete(repo.findById(id).orElseThrow(()->new DoctorNotFoundException("DOCTOR NOT EXIST")));
	...
	@Override
	@Transactional
	public String updateDocDeptById(Long id, String docDept) {
