package com.techwish.hms.config1;
...
public class SwaggerConfig {
	...
	private ApiInfo ApiInfo() {
		...
		return new ApiInfo("HMS APPLICATION",
				"DEVELOPED BY JAVA TEAM",
				"3.2GA","http://sample.com",
				new Contact("Sachin","http://sample.com/sachin","javabysachin@gmail.com"),
